...
- `island`: indicates island in the palmer Archipelago
...
**Response**: The chinstrap and Adelie penguins tend to have shorter flipper lengths (and are more similar to each other) than Gentoo penguins. 
...
**Response**: The jitter plot hides the raw data less, which can be considered a good practice, but in this case I don't think it's very valuable to be able to see individual observations. The summary statistics supplied by the boxplots seem like they're better for this exploratory phase. 
